...
class ExecutionEngine { 
 ...
 private:
  /** The buffer pool manager used during query execution 查询执行期间使用的缓冲池管理器 */    
  [[maybe_unused]] BufferPoolManager *bpm_;
  /** The transaction manager used during query execution 查询执行期间使用的事务管理器*/
  [[maybe_unused]] TransactionManager *txn_mgr_;
  /** The catalog used during query execution  查询执行期间使用的目录 */
